...
file_name = "2"#"pavan_noseg"#"Van_Skeleton"#"sequence-Van_Skeleton_segment_2"
brush_name = "brush_7"
INPUT_JSON_FILE = f"json/style/{file_name}-combined-dsequence-with_attributes.json"  # Input JSON file
OUTPUT_VIDEO_NAME = f"results/style/{file_name}-combined-sequence-{brush_name}-combined-output-video-polygonandcropimageR1.mp4"  # Output video file
LAST_FRAME_OUTPUT = f"results/style/{file_name}-combined-sequence-{brush_name}-combined-last_frame-polygonandcropimageR1.png"  # Last frame output
